...
def novo_flashcard(request):
    ...
    if request.method == "GET":
        ...
        return render(request, 'novo_flashcard.html', {'categorias':categorias, 'dificuldades':Flashcard.DIFICULDADE_CHOICES, 'flashcards': flashcards})
    ...
    if request.method == "POST":
        ...
        if len(pergunta.strip()) == 0 or len(resposta.strip()) == 0:
            messages.add_message(request, constants.ERROR, 'Campos de Pergunta e Resposta são obrigatorios')
